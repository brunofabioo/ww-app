...
export default function CriarAtividade() {
  ...
  useEffect(() => {
    ...
    if (savedDraft) {
      if (isNewExam) {
        // Só mostra o modal se o usuário clicou em "Nova Atividade" e há rascunho
  ...
  const handleGenerateExam = async () => {
    ...
    // Limpar rascunho após gerar atividade com sucesso
    clearDraft();
    setLastSaved("");
          ...
          <div className="mb-6 flex items-center justify-between">
            <Button
              ...
              onClick={() => {
                ...
                localStorage.removeItem("criar-atividade-preview");
                setLastSavedPreview("");
              }}
              ...
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-slate-600">
                    Defina o título, idioma e nível de dificuldade da sua atividade
                  </p>
                </div>

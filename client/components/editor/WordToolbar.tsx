...
export function WordToolbar({ 
  ...
  // Versão mobile enxuta
  if (isMobile) {
    return (
      <div className="border-b border-border bg-background p-2 space-y-2">
        {/* Linha principal mobile - apenas ferramentas essenciais */}
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Menu de ferramentas adicionais */}
          <DropdownMenu>
        ...
        {/* Segunda linha mobile - zoom e estatísticas compactas */}
        <div className="flex items-center justify-between gap-2">
